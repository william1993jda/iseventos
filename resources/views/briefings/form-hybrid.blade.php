<x-app-layout>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12">
            ...
            @if (empty($briefing->id))
                {!! Form::open([
                    'route' => 'briefings.store.hybrid',
                    'method' => 'post',
                    'class' => 'needs-validation',
                ]) !!}
            @else
                {!! Form::model($briefing, [
                    'route' => ['briefings.update.hybrid', $briefing->id],
                    'method' => 'put',
                    'class' => 'needs-validation',
                ]) !!}
            @endif
            ...
            <div class="col-span-12 xl:col-span-8 mt-6">
                ...
                <div class="col-span-12 xl:col-span-8 mt-6">
                    <div class="intro-y block sm:flex items-center h-10">
                        <h2 class="text-lg font-medium truncate mr-5">
                            Equipamentos Tranmissão
                        </h2>

                    </div>
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        <div class="sm:grid grid-cols-2 gap-2 mt-3">
                            <x-forms.select name="teleprompter" label="Teleprompter:" :options="['0' => 'Selecione...', '1' => 'Sim', '2' => 'Não']" />
                            <x-forms.text name="teleprompter_quantity" label="Quantidade" />
                        </div>
                    </div>
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        <div class="sm:grid grid-cols-2 gap-2 mt-3">
                            <x-forms.select name="ipad" label="Ipad:" :options="['0' => 'Selecione...', '1' => 'Sim', '2' => 'Não']" />
                            <x-forms.text name="ipad_quantity" label="Quantidade" />
                        </div>
                    </div>
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        <div class="sm:grid grid-cols-1 gap-2 mt-3">
                ...
                <div class="col-span-12 xl:col-span-8 mt-6">
                    ...
                    <div class="intro-y box p-5 mt-12 sm:mt-5">
                        ...
                        <div class="sm:grid grid-cols-2 gap-2 mt-3">
                            <x-forms.text name="studio_amount" label="Quantos speakers in loco:" />
