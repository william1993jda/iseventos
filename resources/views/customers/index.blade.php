<x-app-layout>
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
                        ...
                        <tr class="intro-x">
                            <td>
                                <a href="{{ route('customers.show', $customer->id) }}"
                                    class="font-medium whitespace-nowrap">{{ $customer->fantasy_name }}</a>
                            </td>
                            <td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    <x-forms.buttons.edit :route="route('customers.edit', $customer->id)" />
                                    <x-forms.buttons.delete :route="route('customers.destroy', $customer->id)" />
                                </div>
                            </td>
                        </tr>
                    @endforeach
        ...
        {{ $customers->links('layouts.paginator') }}
